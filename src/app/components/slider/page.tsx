...
export const Slider = () => {
  ...
  return (
    ...
    <MotionDiv
        ...
        viewport={{ amount: 0 }}>
    <div id="avaliações" className="flex justify-center items-center flex-col p-20 bg-[url('/images/parede.jpg')] bg-cover bg-hero-image bg-center z-0"> 
    <h1 className="text-7xl font-bold mb-4 p-5 text-center text-orange-200 max-sm:text-6xl">AVALIAÇÕES DOS NOSSOS <span className="text-white "><br />CLIENTES</span></h1>
      <h2 className="text-5xl font-bold mb-4 p-9 text-center text-orange-100 max-sm:text-4xl max-sm:p-0">VENHA NOS CONHECER!</h2>
